$(document).ready(function () {
  const contentString =
    "<h4 class='info-head'>Dowry Road, Clifton Wood</h4><p><i class='fas fa-bed'></i> 4  &emsp;<i class='fas fa-bath'></i> 1 &emsp; <i class='fas fa-pound-sign'></i> 555 each pcm </p>";

  let pos;
  let map;
  const myLatLng = { lat: 51.4517,
            lng: -2.6202};
  let markers = [];
