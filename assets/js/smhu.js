$(document).ready(function () {
  const contentString =
    "<h4 class='info-head'>Saint Michael's Hill Upper, Cotham</h4><p><i class='fas fa-bed'></i> 5  &emsp;<i class='fas fa-bath'></i> 2 &emsp; <i class='fas fa-pound-sign'></i> 560 each pcm </p>";

  let pos;
  let map;
  const myLatLng = { lat: 51.4603,
            lng: -2.6016};
  let markers = [];
  ...
  function initMap() {
    ...
    const marker = new google.maps.Marker({
      position: myLatLng,
      map,
      title: "Saint Michael's Hill Upper",
    });
