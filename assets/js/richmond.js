$(document).ready(function () {
  const contentString =
    "<h4 class='info-head'>Richmond Hill Avenue</h4><p><i class='fas fa-bed'></i> 3  &emsp;<i class='fas fa-bath'></i>1 &emsp; <i class='fas fa-pound-sign'></i> 570 each pcm </p>";

  let pos;
  let map;
  const myLatLng = { lat: 51.4568,
            lng: -2.6121};
  let markers = [];
