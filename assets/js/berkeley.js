$(document).ready(function () {
  const contentString =
    "<h4 class='info-head'>Berkeley Avenue, Redland</h4><p><i class='fas fa-bed'></i> 4  &emsp;<i class='fas fa-bath'></i> 2 &emsp; <i class='fas fa-pound-sign'></i> 525 each pcm </p>";

  let pos;
  let map;
  const myLatLng = { lat: 51.4769,
            lng: -2.5974};
  let markers = [];
